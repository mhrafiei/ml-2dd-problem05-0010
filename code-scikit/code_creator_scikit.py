...
for lay_neuron in lay_neuron_all:
	...
	for i0 in rtt:
		for i1 in rrs:
			...
			if os.path.exists("master_scikit_{}_{}_{}.py".format(i0+1,i1+1,tail_val)):
				os.remove("master_scikit_{}_{}_{}.py".format(i0+1,i1+1,tail_val))

			if os.path.exists("ja_{}_{}_{}".format(i0+1,i1+1,tail_val)):
				os.remove("ja_{}_{}_{}".format(i0+1,i1+1,tail_val))

			f  = open("master_scikit_{}_{}_{}.py".format(i0+1,i1+1,tail_val), "x")
			f0 = open("code_info_scikit.txt","r")
